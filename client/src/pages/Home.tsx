  ...
  return (
    <main>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-visual"><div className="image-frame"><img src={HERO_IMAGE} alt="Lucas Martins sentado em um escritório simples" /><div className="image-caption"><span>LUCAS MARTINS</span><span>EXPERT DA MARCA</span></div></div><div className="vertical-word">CLAREZA / PRESENÇA / RESPEITO</div></div>
      </section>
