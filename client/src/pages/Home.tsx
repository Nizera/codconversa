...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="offer" id="oferta"><div className="offer-intro"><SectionLabel>ESCOLHA SEU PONTO DE PARTIDA</SectionLabel><h2>Comece pela conversa que você quer construir.</h2><p>Dois planos, sem urgência artificial. Escolha o nível de aprofundamento que faz sentido para o seu momento.</p></div><div className="plans"><article className="plan"><span className="plan-label">PLANO BÁSICO</span><h3>Código da Conversa</h3><p className="plan-desc">O método essencial para mensagens e interações mais naturais.</p><div className="price"><small>de R$ 49,90 por</small><br /><small>R$</small>14<sup>90</sup></div><ul><li><Check size={17} /> Ebook principal</li><li><Check size={17} /> 100 mensagens prontas</li><li><Check size={17} /> 20 respostas para visualização</li></ul><a className="button button-outline" href={checkoutBasico}>QUERO COMEÇAR AGORA <ArrowUpRight size={16} /></a></article><article className="plan plan-featured"><span className="plan-label">MAIS VENDIDO</span><h3>Protocolo Anti-Rejeição</h3><p className="plan-desc">Tudo do básico + um treinamento para agir com mais confiança e respeitar seus próprios limites.</p><div className="price"><small>de R$ 89,90 por</small><br /><small>R$</small>27<sup>90</sup></div><ul><li><Check size={17} /> Tudo do Plano Básico</li><li><Check size={17} /> 6 módulos adicionais</li><li><Check size={17} /> Desafio de confiança de 7 dias</li></ul><a className="button button-copper" href={checkoutPremium}>QUERO O PREMIUM <ArrowUpRight size={16} /></a></article></div></section>
